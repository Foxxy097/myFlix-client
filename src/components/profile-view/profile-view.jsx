...
export class ProfileView extends React.Component {
  ...
  getUser = (token) => {
    ...
    axios
      .get(`https://myflixapp1.herokuapp.com/users/${Username}`, {
      ...
      .then((response) => {
        this.setState({
          ...
          FavoriteMovies: response.data.FavoriteMovie
        });
      })
  ...
  editUser = (e) => {
    ...
    axios
      .put(
        `https://myflixapp1.herokuapp.com/users/${Username}`,
        {
  ...
  onRemoveFavorite = (e, movie) => {
    ...
    axios
      .delete(
        `https://myflixapp1.herokuapp.com/users/${Username}/movies/${movie._id}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      )
  ...
  onDeleteUser() {
    ...
    axios
      .delete(`https://myflixapp1.herokuapp.com/users/${Username}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((response) => {
        console.log(response);
